...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\ai'chi'tang'cu\PycharmProjects\DiceGame'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\ai'chi'tang'cu\PycharmProjects\DiceGame\Scripts\deactivate.nu'
